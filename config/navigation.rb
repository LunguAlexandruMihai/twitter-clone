...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :wback , "Welcome back "+current_user.try(:email),"#",if: -> { user_signed_in? }
    primary.item :all_tweets , "All tweets",all_tweets_path,if: -> { user_signed_in? }

    primary.item :logout, "Logout", destroy_user_session_path, method: :delete,class: 'special', if: -> { user_signed_in? }

    primary.dom_attributes = {class: 'nav navbar-nav navbar-right'}
  end
end
